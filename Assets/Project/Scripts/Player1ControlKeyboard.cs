...
public class Player1ControlKeyboard : MonoBehaviour
{
    ...
    private InputSystem_ActionsKeyboard control;

    [SerializeField] private UIManager pausa;

    private void Awake()
    {
        control = new InputSystem_ActionsKeyboard();
    }
